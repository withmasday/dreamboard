...
Route::get('/auth/redirect', [LoginController::class, 'googleAuth'])->name('googleAuth');
Route::get('/auth/callback', [LoginController::class, 'googleCallback'])->name('googleCallback');
